            ...
            <form action="sousmission" method="POST">
                ...
                <div class="w3-row-padding" style="margin:0 -16px;">
                    <div class="w3-half w3-margin-bottom">
                        ...
                        <input class="w3-input w3-border" type="text" placeholder="Nom" name="last_name" required>
                    </div>
                    <div class="w3-half">
                        <label><i class="fa"></i>Prénom</label>
                        <input class="w3-input w3-border" type="text" placeholder="Prénom" name="first_name" required>
                    </div>
                </div>
                ...
                <div class="w3-row-padding" style="margin:8px -16px;">
                    <div class="w3-quarter">
                        ...
                        <select name="vehicle" class="w3-input">
