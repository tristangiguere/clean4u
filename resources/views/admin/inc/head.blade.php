...
<body>
    <nav class="navbar navbar-light navbar-expand-lg fixed-top clean-navbar" style="padding: 8px;background-color: black;">
        <div class="container"><a class="navbar-brand logo" href="<?php echo url('/admin/quotes');?>" style="color: white;"><strong>Clean4U</strong> Admin</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
