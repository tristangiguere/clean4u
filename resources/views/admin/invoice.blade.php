            ...
            <div class="container" style="margin-bottom: 20px;padding-left: 0px;padding-right: 0px;">
                <div class="d-flex justify-content-between align-items-center" style="margin-bottom: 30px;">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 id="invoice-title" style="margin: 0px;">Invoice #0001</h1>
                    </div>
            ...
            <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="customer-info-section">
                                    ...
                                    <p class="customer-info-content">Due on receipt</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="row d-flex justify-content-between">
                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 customer-info-column">
                        ...
                        <div class="row itemrow">
                            <div class="col-md-3 col-lg-3 col-xl-4">
                                <p class="customer-info-header">Deep Car Wash</p>
                            </div>
                            <div class="col-md-3 col-lg-4 col-xl-4">
                                <p class="customer-info-header">Complete Interior + Exterior</p>
                            </div>
                            <div class="col">
                                <p class="customer-info-header">24.99$</p>
                            </div>
                            <div class="col">
                        ...
                        <div class="row" style="padding-top: 5px;">
                            <div class="col">
                                <div class="customer-info-section">
                                    ...
                                    <p class="customer-info-content">24.99$</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="customer-info-section">
                            ...
                            <div class="col">
                                <div class="customer-info-section">
                                    ...
                                    <p class="customer-info-content">3.74$</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="customer-info-section">
                                    <p class="customer-info-header">Total</p>
                                    <p class="customer-info-content">28.73$</p>
                                </div>
                            </div>
                        </div>
                    </div>
